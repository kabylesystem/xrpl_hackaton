...
export const NFCPayment: React.FC<NFCPaymentProps> = ({ onBack, onComplete }) => {
    ...
    return (
      <div className="min-h-screen bg-[#F8F9FB] dark-mode:bg-[#121212] flex flex-col">
        <div className="px-6 pt-12 pb-6 flex items-center gap-4">
          ...
          <h2 className="text-[#1A1A1A] dark-mode:text-white">NFC Payment</h2>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6">
          ...
          <div className="text-center mt-8">
            <h2 className="text-[#1A1A1A] dark-mode:text-white mb-2">
              Hold your phone near the merchant
            </h2>
